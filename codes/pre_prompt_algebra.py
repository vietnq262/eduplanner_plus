...
# AAEA_MODEL       = "openai/gpt-4o-mini"
# CIDPP_MODEL      = "openai/gpt-4o-mini"
# AQS_MODEL        = "openai/gpt-4o-mini"                         # ← NEW
...
- **Include deep connections between knowledge points to inspire critical thinking.**
- **Explain the WHY behind each solving step, not just the HOW.**
- **Use real-world scenarios: shopping, temperature, speed, finance, cooking measurements.**
- **Each exercise must state a real-life context before presenting the math problem.**
- **Show how solving this type of problem helps in daily life.**
...
# selected_questions — initial round only (random baseline)  ← NEW COMMENT
